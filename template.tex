...
This emphasizes the need for uncertainty visualization systems to be \textit{scale-aware}: it is not possible to comprehensively implement uncertainty visualization purely as a data pre-processing step.
...
The full source of \textit{ggdist} itself is available on Zenodo at \href{https://doi.org/10.5281/zenodo.3879620}{doi:10.5281/zenodo.3879620} and on GitHub at \href{https://github.com/mjskay/ggdist}{github.com/mjskay/ggdist}, released under a GPL 3.0 license.
