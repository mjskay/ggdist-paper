...
```{r cran-downloads, echo = FALSE, fig.cap = "Downloads of \\textit{ggdist} and \\textit{tidybayes} over time, as average downloads per day within each month. In June of 2020, the visualization functionality of \\textit{tidybayes} was split off into a new package, \\textit{ggdist}, to reflect its usefulness beyond just Bayesian modeling. As of this writing, \\textit{ggdist} averages about 9,000 downloads/month or 300 downloads/day."}
